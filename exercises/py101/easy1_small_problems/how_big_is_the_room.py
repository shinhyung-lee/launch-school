...
# ask the user if the input will be in meters or feet (unit variable)
# if they are not in correct string format, ask them to enter again 
unit = input("Enter the unit for this program (\"m\" for meter, \"f\" for feet): ")
while unit not in ["m", "f"]:
    unit = input("Wrong input. Please enter \"m\" for meter, \"f\" for feet: ")

# print("Got here") to check progress
print("made it here")